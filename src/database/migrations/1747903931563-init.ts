...
export class Init1747903931563 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`solution_galery\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`image\` varchar(255) NOT NULL, \`solutionId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    await queryRunner.query(
      `CREATE TABLE \`call_galery\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`image\` varchar(255) NOT NULL, \`callId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`solution_galery\` ADD CONSTRAINT \`FK_886108c635208f12c6cf2b8e7a8\` FOREIGN KEY (\`solutionId\`) REFERENCES \`solution\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`call_galery\` ADD CONSTRAINT \`FK_2b7f3b5895806192176f409be19\` FOREIGN KEY (\`callId\`) REFERENCES \`call_solution\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`call_galery\` DROP FOREIGN KEY \`FK_2b7f3b5895806192176f409be19\``);
    await queryRunner.query(`ALTER TABLE \`solution\` DROP FOREIGN KEY \`FK_a4120c4fb94efaef567362bc42b\``);
    await queryRunner.query(`ALTER TABLE \`solution\` DROP FOREIGN KEY \`FK_a6d648bdb9da84b174d72b5d9c1\``);
    await queryRunner.query(`ALTER TABLE \`solution\` DROP FOREIGN KEY \`FK_577971bf35a3f85b2d6edd8329e\``);
    await queryRunner.query(`ALTER TABLE \`solution_galery\` DROP FOREIGN KEY \`FK_886108c635208f12c6cf2b8e7a8\``);
    await queryRunner.query(`ALTER TABLE \`review\` DROP FOREIGN KEY \`FK_cb2eff561603c229ad4bce0fb0a\``);
    await queryRunner.query(`ALTER TABLE \`partner\` DROP FOREIGN KEY \`FK_8aef3f06fd8d7a645cc2b9fdf21\``);
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE \`call_galery\``);
    await queryRunner.query(`DROP TABLE \`solution_galery\``);
    await queryRunner.query(
